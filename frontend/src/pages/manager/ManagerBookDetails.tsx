...
export const ManagerBookDetails: React.FC = () => {
  ...
  const handleDeleteBook = async () => {
    ...
    if (book.status === "borrowed" || book.current_borrowing) {
      toastError(
        "Action refusée",
        "Ce livre est actuellement emprunté et ne peut pas être supprimé."
      );
          ...
          <div className="p-6 rounded-xl bg-[#111114] border border-zinc-800 space-y-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-xs">
              ...
              <div>
                ...
                <span className="text-zinc-300">
                  {book.published_year || "Non renseignée"}
                </span>
              </div>
              <div>
              ...
              <div>
                <span className="text-zinc-500 block mb-0.5">
                  Total d'emprunts historiques
                </span>
                <span className="text-zinc-300 font-semibold">
                  {book.total_borrowings_count || 0} prêts
                </span>
              </div>
            </div>
            ...
            {book.description && (
              <div className="pt-4 border-t border-zinc-800">
                <span className="text-zinc-500 text-xs block mb-1.5">
                  Résumé / Présentation
                </span>
                  ...
                  >
                    <div>
                      ...
                      <div className="flex items-center gap-2 text-[11px] text-zinc-500 mt-0.5">
                        ...
                        <span>
                          {bw.returned_at
                            ? `Retourné le ${formaterDate(bw.returned_at!)}`
                            : `Échéance : ${formaterDate(bw.due_date)}`}
                        </span>
                      </div>
                    </div>
                    ...
                    <div className="space-y-2 text-xs pt-1">
                      ...
                      <div className="grid grid-cols-2 gap-2 pt-2 border-t border-amber-900/40">
                        <div>
                          ...
                          <span className="font-mono text-zinc-300">
                            {formaterDate(book.current_borrowing.borrowed_at)}
                          </span>
                        </div>
                        <div>
                          <span className="text-zinc-500 block text-[11px]">
              ...
              <div className="p-4 rounded-lg bg-emerald-950/20 border border-emerald-800/40 space-y-3 text-center">
                ...
                <div>
                  ...
                  <p className="text-[11px] text-zinc-400 mt-0.5">
                    Cet ouvrage est en rayon et peut être attribué à un
                    emprunteur.
                  </p>
                </div>
                <Button
